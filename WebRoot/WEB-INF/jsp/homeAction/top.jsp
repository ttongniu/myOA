...
<body CLASS=PageBody leftmargin=0 topmargin=0 marginwidth=0 marginheight=0>
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:#F1F9FE; font-size:28px; font-family:Arial Black, Arial">协同办公OA</font> 
		...
		<div id="Head1Right">
			...
			<div id="Head1Right_UserSetup">
            	<a target="right" href="person_editInfoUI.action"><img border="0" width="13" height="14" src="${pageContext.request.contextPath}/style/images/top/user_setup.gif" /> 个人设置</a>
			</div>
    ...
    <div id="Head2">
        <div id="Head2_Awoke">
            <ul id="AwokeNum">
               ...
               <%--  <li><a href="${pageContext.request.contextPath}/formFlowAction_myTaskList.action" target="right">
                ...
                <!-- 是否有待审批文档的提示2 -->
               <%--  <s:if test="#taskViewList!=null">
                <li id="messageArea">有待审批文档☆☆☆☆☆</li>
                </s:if>
                 <li class="Line"></li> --%>
            </ul>
        </div>
        ...
        <div id="Head2_FunctionList" >
			<marquee style="WIDTH: 97%;" onMouseOver="this.stop()" onMouseOut="this.start()" 
				scrollamount=1 scrolldelay=30 direction=left>
				<b>欢迎使用协同办公系统！如有问题及时联系--牛铜铜ttongniu@163.com</b>
			</marquee>
		<span>	<a href="javascript: window.parent.right.location.reload(true);">刷新</a></span>
        </div>
