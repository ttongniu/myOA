...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
               <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 个人名片夹列表
        </div>
    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <s:iterator value="recordList">
			<tr class="TableDetail1 template">
				<td style="width: 25% ;text-align: center"><s:a action="card_list?id=%{id}">&nbsp;${name}&nbsp;</s:a></td>
				<td style="width: 25%;text-align: center">&nbsp;${description}&nbsp;</td>
				<td style="width: 25%;text-align: center">&nbsp;${createTime}&nbsp;</td>
				<td style="width: 25%;text-align: center">
                 <s:a action="card_list?id=%{id}">查看名片夹</s:a>
                </td>
				<%-- <c:if test="${type==0}">
                <td style="width: 15%">&nbsp;私有&nbsp;</td>
                </c:if>
                <c:if test="${type==1}">
                <td style="width: 15%">&nbsp;共享&nbsp;</td>
                </c:if>
